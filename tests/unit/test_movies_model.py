...
def test_new_movie():
    movie = Movie(original_language='en', original_title='Test', overview='jkljkl', vote_average=6.12, release_date=2023-11-22, poster_path="https://image.tmdb.org/t/p/w500/jE5o7y9K6pZtWNNMEw3IdpHuncR.jpg", genres=[])
